...
final class TestStandardCarImplWithAccessChecking extends TestStandardCarImpl
{
    ...
    private static final FixedKeyMapCreator MOVE_MAP_CREATOR = new FixedKeyMapCreator("mileage");

    public int move(final int mileage)
    {
        authorise(INVOKE_METHOD("move"), MOVE_MAP_CREATOR.createMap(mileage));

        return super.move(mileage);
    }
